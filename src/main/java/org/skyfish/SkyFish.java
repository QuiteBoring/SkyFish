...
public class SkyFish {
    ...
    private final KeyBinding testSound = new KeyBinding("Test Sound", Keyboard.KEY_B, "SkyFish");
    ...
    public void init(FMLInitializationEvent event) {
        ...
        ClientRegistry.registerKeyBinding(testSound);
